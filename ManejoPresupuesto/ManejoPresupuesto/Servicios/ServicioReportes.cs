...
namespace ManejoPresupuesto.Servicios
{
    ...
    public class ServicioReportes : IServicioReportes
    {
        ...
        {
            (DateTime fechaInicio, DateTime fechaFin) = GeneraFechaInicioYFin(mes, ano);
        ...
        private (DateTime fechaInicio, DateTime fechaFin) GeneraFechaInicioYFin(int mes, int ano)
        {
